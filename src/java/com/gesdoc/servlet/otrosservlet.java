 ...
 * @author wiwi_
 */
@WebServlet(name = "otrosservlet", urlPatterns = {"/otrosservlet"})
public class otrosservlet extends HttpServlet {
    String listar = "listar_otros.jsp";
    String agregarotro = "regisotros.jsp";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            daootros.agregarotros(otrosradicados);
                ...
                try {
                    ...
                    seguimiento.setAccAcciones("El usuario realizo un nuevo registro en otros");
            ...
            otrosradicados.setOtrId(id);
            daootros.eliminarotros(id);
