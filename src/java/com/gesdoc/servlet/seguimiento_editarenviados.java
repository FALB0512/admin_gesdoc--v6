 ...
 * @author jorge
 */
public class seguimiento_editarenviados extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet seguimiento_editarenviados</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet seguimiento_editarenviados at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            HttpSession session = request.getSession();
                    ...
                    String envNumeroRadicado = (String) session.getAttribute("envNumeroRadicado");
                    ...
                    seguimiento.setAccAcciones("El usuario editò en enviados");
        ...
        response.sendRedirect("listar_enviados.jsp");
    }
