 ...
 * @author jorge
 */
public class seguimiento_editarrecibidos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet seguimiento_editarrecibidos</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet seguimiento_editarrecibidos at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            HttpSession session = request.getSession();
                    ...
                    String radNumeroRadicado = (String) session.getAttribute("radNumeroRadicado");
                    ...
                    seguimiento.setAccAcciones("El usuario editò en recibidos");
        ...
        response.sendRedirect("listar_recibidos.jsp");
    }
