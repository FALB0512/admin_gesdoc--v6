...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <%
            ...
            String nom = (String) session.getAttribute("nom"); // Obtén 'nom' desde la sesión
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="container">
                            <h1 class="text-center" style=" margin-top: -15px; padding: 20px">Registro Correspondencia Enviada </h1>
                                    ...
                                    <div class="row" style="padding-bottom: 10px">
                                        ...
                                        <div class="col-md-6" >
                                            ...
                                            <div class="form-group" >
                                                ...
                                                <input type="date" name="fecha_recepcion" class="form-control" id="fecha_recepcion" name="fechaRadicacion" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="NombreFuncionario">Nombre del Funcionario<span class="form-required">*</span></label>
                                                <input type="text" name="NombreFuncionario" class="form-control" id="NombreFuncionario" required>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="TipoDocumental" class="form-control" id="TipoDocumental" required>
                                            </div>  
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="Antecedentes" class="form-control" id="Antecedentes" required>
                                            </div>


                                            <div class="form-group" style="padding: 10px">
                                                <label for="archivo">Archivo<span class="form-required">*</span></label>
                                                <input type="file" class="form-control-file" id="archivo" name="archivopdf" required>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="Entidad" class="form-control" id="Entidad" required>
                                            </div>               
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nombre_destinatario" class="form-control" id="nombre_destinatario" required>
                                            </div>      

                                            <div class="form-group">
                                                <label for="Observaciones">Observaciones<span class="form-required">*</span></label>
                                                <input type="text" name="Observaciones" class="form-control" id="Observaciones" required>
                                            </div>   
    ...
    document.getElementById("generarBtn").addEventListener("click", function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire('Número de radicado generado', 'Tu número de radicado es: 2-' + numeroFormateado, 'success');
            }
        });
    });
