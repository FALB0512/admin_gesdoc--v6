<%-- 
    ...
    Created on : 29/11/2023, 7:26:34 p. m.
    Author     : farud
--%>
...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">              
        ...
        <div>
            <h1 style="color: black; text-align: center">Seguimiento a las operaciones realizadas por los usuarios</h1>
        </div>
...
-->                             <td><%= act.getAccUsuario()%></td><!--
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-danger" href="javascript:void(0);" onclick="confirmarEliminacion(<%= act.getAccId()%>)">
