...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
       ...
       <form class="jotform-form" action="otrosservlet" method="get"/>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="container">
                            <h1 class="text-center" style=" margin-top: -15px; padding: 20px">Registro Otros Envio Recibidos </h1>
                                    ...
                                    <div class="row" style="padding-bottom: 10px">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group" style="">
                                                    ...
                                                    <input type="text"  name="numero_radicado" class="form-control" id="numero_radicado" stylename="numero_radicado" required maxlength="10">

                                                </div>
                                            <div class="form-group">
                                                <label for="nombre_entidad">Nombre Entidad O Remitente<span class="form-required">*</span></label>
                                                <input type="text" name="nombre_entidad" class="form-control" id="nombre_entidad" required maxlength="200">
                                            </div>

                                            <div class="form-group">
                                                <label for="ciudad">Ciudad de Origen<span class="form-required">*</span></label>
                                                <input type="text" name="ciudad" class="form-control" id="ciudad"  required maxlength="100">
                                            </div>
                                        ...
                                        <div class="col-md-6" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="tipo_documental" class="form-control" id="tipo_documental" required maxlength="100">
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="Dependencia" class="form-control" id="dependencia" required maxlength="100">
                                            </div>               
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nombre_funcionario" class="form-control" id="nombre_funcionario" required maxlength="200">
                                            </div>      
...
<script src="js/RegistrarOtros.js" type="text/javascript"></script>
<script src="js/alertas_otros.js" type="text/javascript"></script>
<script>
