document.addEventListener('DOMContentLoaded', function () {
                const camposBloqueados = ['nombre_entidad', 'asunto', 'ciudad', 'Dependencia', 'nombre_destinatario', 'nombre_destinatario'];
                
                const campoNumerico = ['numero_origen', 'anexos', 'NumeroRadRespuesta'];
