    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div>
                    <h1 style="color: black; text-align: center">Usuarios</h1>
                </div>
...
<!--                                            <th>Segundo Apellido</th>-->
                                    ...
                                    <tbody>
                                        ...
                                        <%
                                            ...
                                            List<consultausuario> list = dao.listar();
                                            Iterator<consultausuario> iter = list.iterator();
                                            consultausuario act = null;
                                            while (iter.hasNext()) {
                                                act = iter.next();
                                        %>
                                        ...
                                        <tr>
                                            <td><%= act.getUsuId()%></td>
                                            <td><%= act.getUsuPrimerNombre()%></td>
                                            <!--<td><%= act.getUsuSegundoNombre()%></td>-->
                                            <td><%= act.getUsuPrimerApellido()%></td>
                                            <!--<td><%= act.getUsuSegundoApellido()%></td>-->
                                            <td><%= act.getUsuNombreUsuario()%></td>
                                            <td><%= act.getUsuCorreo()%></td>

                                            <td>
                                                <a class="btn btn-warning" href="EditarUsuariosServlet?accion=editar&id=<%= act.getUsuId()%>">
                                                    <i class="fas fa-edit" style="text-align: center;"></i> <!-- Icono de editar -->
                                                </a>

                                                <a class="btn btn-danger" href="javascript:void(0);" onclick="confirmarEliminacion(<%= act.getUsuId()%>)">
                                 ...
                                 <div style="padding: 20px; left: 0%;position: relative;">                                                                                                                                  
                                    <a style="background: #0AAA0A" class="btn btn-success" href="UserServlets?accion=add">Agregar</a>                                                                                    
                                </div>
                            </div>
                        </div>
                    </div>  
                                                    ...
                                                    function confirmarEliminacion(id) {
                                                        Swal.fire({
                                                            ...
                                                            if (result.isConfirmed) {
                                                                window.location.href = 'UserServlets?accion=eliminar&id=' + id;
                                                            }
                                                        });
                                                    }
</script>
